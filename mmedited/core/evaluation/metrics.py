...
from mmedit.core.evaluation.metric_utils import gauss_gradient
...
if in_fbcode:
    ...
    niqe_path = g_pathmgr.get_local_path('manifold://on_device_sr/tree/jinliang/realdenoisevsr/load_file/niqe_pris_params.npz')
else:
    niqe_path = 'mmedited/core/evaluation/niqe_pris_params.npz'
...
def niqe(img, crop_border, input_order='HWC', convert_to='y'):
    ...
    # we use the official params estimated from the pristine dataset.
    niqe_pris_params = np.load(niqe_path)
