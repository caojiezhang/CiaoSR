exp_name = '002_real_wogan_localimplicitsr_swinir_df2k_g1_c64b16_1000k_unfold_lec_mulwkv'
...
train_cfg = None
test_cfg = dict(metrics=[], crop_border=val_scale, scale=val_scale, tile=128, tile_overlap=32) #['PSNR', 'SSIM'] , convert_to='y'
...
train_pipeline = [
    ...
    dict(type=GenerateCoordinateAndCell1, sample_quantity=4096),
    dict(
        type='Collect',
...
data = dict(
    ...
    test=dict(
        ...
        # lq_folder=f'{mydata_dir}/Classical/Urban100/LRbicx4',  #f'{data_dir}/testset/DIV2K_val/LR_bicubic/X2', #f'{mydata_dir}/Classical/Set14/LRbicx4', #f'{mydata_dir}/Classical/BSDS100/LRbicx2',  #
        # gt_folder=f'{mydata_dir}/Classical/Urban100/GTmod12',  #f'{data_dir}/testset/DIV2K_val/HR', #f'{mydata_dir}/Classical/Set14/GTmod12', #f'{mydata_dir}/Classical/BSDS100/GTmod12',  #
        # pipeline=test_pipeline,
        # scale=scale_max,
        # filename_tmpl='{}'))   #x4
        type=test_dataset_type,
        lq_folder=f'{mydata_dir}/RealSR/RealSRSet',  #f'{mydata_dir}/Classical/Urban100/GTmod12',  #f'{data_dir}/testset/Set5/HR', #f'{data_dir}/testset/Urban100/HR',  #f'{data_dir}/sr_test/Set5', #
        gt_folder=f'{mydata_dir}/RealSR/RealSRSet',
        pipeline=real_pipeline,
        scale=val_scale,
        filename_tmpl='{}'))

# optimizer
optimizers = dict(generator=dict(type='Adam', lr=2.e-4, betas=(0.9, 0.99)))
