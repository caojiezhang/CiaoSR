...
data = dict(
    ...
    test=dict(
        ...
        # filename_tmpl='{}'))   #x4
        type=test_dataset_type,
        lq_folder=f'{mydata_dir}/RealSR/DPED',  #f'{mydata_dir}/RealSR/RealSRSet',  #f'{mydata_dir}/Classical/Urban100/GTmod12',  #f'{data_dir}/testset/Set5/HR', #f'{data_dir}/testset/Urban100/HR',  #f'{data_dir}/sr_test/Set5', #
